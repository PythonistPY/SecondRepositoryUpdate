...
text1 = tk.Label(root, text="Введите свою задачу ", bg="DarkSlateGrey",)
text1.pack(pady=10)
...
text2 = tk.Label(root, text="Ваш Список Задач!", bg="dark green")
text2.pack(pady=50)


task_list_box = tk.Listbox(root, height=35, width=70, bg="DarkSlateGrey", selectmode=tk.SINGLE)
